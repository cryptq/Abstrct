<?php
	...
	/**
	*
        * @param (string)         private $_ApiKey = 'YOUR_COMPANIES_HOUSE_API_KEY';
        * @param                  require_once('CompaniesHouse.php');
        * @param                  $CompaniesHouse = new CompaniesHouse; var_dump($CompaniesHouse->company_profile('10131005'));
	*
	*/
